...
function PagerLink({
  ...
  return (
    <Link
      ...
      className={`group flex min-w-0 items-center gap-0.5 rounded-full px-2 py-2 pointer-coarse:py-3 hover:backdrop-blur-md transition hover:border-white/20 hover:bg-white/10 sm:px-4 ${
